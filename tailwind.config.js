  ...
  theme: {
    extend: {
      backgroundImage: theme => ({
        ...
        'liner-web-work': "url('../public/images/liner-web.svg')",
        'liner-be-work': "url('../public/images/liner-be.svg')",
        'quantcash-work': "url('../public/images/quantcash-work.svg')",
        'hlm-work': "url('../public/images/hlm-work.svg')",
        'pw-work': "url('../public/images/pw-work.svg')",
